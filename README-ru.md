...
- `info(_:)`, `warning(_:)`, `error(_:)`, `debug(_:)` — устанавливают тип
...
Эквивалентные перегрузки существуют для `warning`, `debug` и двух версий
...
Вызов любого метода логирования (`info()`, `warning()`, `error()`, `debug()`)
